...
namespace LearnS.DataAccess.Migrations
{
    ...
    [Migration("20231121184807_UpdateForumsModels")]
    partial class UpdateForumsModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearnS.Models.ForumComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "komentarz",
                            CreatedAt = new DateTime(2023, 11, 21, 19, 48, 7, 174, DateTimeKind.Local).AddTicks(902),
                            ForumPostId = 1,
            ...
            modelBuilder.Entity("LearnS.Models.ForumPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 11, 21, 19, 48, 7, 174, DateTimeKind.Local).AddTicks(867),
                            ForumThreadId = 1,
                            NumberOfViews = 0,
                            UserId = "f096fef9-cdf0-4298-81b1-52925b2ef44d"
                        });
            ...
            modelBuilder.Entity("LearnS.Models.ForumThread", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "zawartość testowa",
                            CreatedAt = new DateTime(2023, 11, 21, 19, 48, 7, 174, DateTimeKind.Local).AddTicks(800),
